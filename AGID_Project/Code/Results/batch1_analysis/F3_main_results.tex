\begin{table}[h]
\centering
\caption{Main results: CBNet-AGID across in-distribution (training generators) and out-of-distribution (unseen generators).}
\label{tab:main}
\begin{tabular}{llcrcccc}
\toprule
Generator & Type & Route & $n$ & Acc (\%) & AUC & Real Acc (\%) & Fake Acc (\%) \\
\midrule
