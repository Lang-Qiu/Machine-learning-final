...
> 本文件由用户授权写入，作为跨会话的 pipeline 状态锁。任何 Claude Code 会话在对本仓库做出任何动作之前**必须**先阅读本文件 + `AGID_Project/docs/experiment_handoff.md`。
...
任何一个新 Claude Code 会话开始工作前，按这个顺序读：
...
| 5 | `C:\Users\LQiu\.claude\projects\E--LQiu-lab-folder-Machine-learning\memory\MEMORY.md` | 项目 memory 索引 |
